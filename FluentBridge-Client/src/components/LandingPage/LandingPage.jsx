...
function LandingPage() {
    ...
    return (
        <div className="bg-gradient-to-b from-[#77369B] to-[#5C2E91] min-h-screen flex flex-col justify-center items-center text-white">
            <header className="text-center mt-10">
                <h1 className="flex items-center justify-center text-4xl font-bold p-6 rounded-2xl">
                    <img src={logo} alt="FluentBridge Logo" className="h-24 mr-2" />
                    FluentBridge Sri Lanka
                </h1>
            </header>
            <main className="text-center text-white mt-8 mx-16">
                <section className="bg-[#231631] bg-opacity-80 rounded-2xl p-3 mx-20 mb-24 shadow-lg">
                ...
                <section className=" rounded-lg p-8 mt-8 mx-10">
                    <h2 className="text-2xl font-semibold mb-6">Activities in FluentBridge</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Activity Box 1 */}
                        <div className="bg-[#231631] bg-opacity-80 p-6 rounded-lg flex flex-col items-center shadow-lg">
                ...
                <section className="bg-[#231631] rounded-2xl p-8 mt-14 mx-10 flex flex-col md:flex-row md:justify-between">
                    <div className="flex flex-col justify-between md:w-2/5 md:mr-6">
                        <h2 className="text-2xl font-semibold mb-6">Contact FluentBridge</h2>
                        <form onSubmit={handleSubmit} className="flex flex-col items-center mb-6">
                            ...
                            <button type="submit" className="bg-[#A779E9] hover:bg-[#8A5BCC] text-white font-bold py-2 px-4 rounded">Send Email</button>
                        </form>
                    </div>
            ...
            <footer className="m-8 text-center bg-[#231631] bg-opacity-80 p-4 text-gray-800 shadow-lg rounded-2xl">
