    ...
    return (
        <div className="relative" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '2rem', position: 'relative' }}>
            ...
            <div className="flex flex-col mx-3 mb-8 justify-center items-center" style={{ zIndex: 2, marginTop: '50px' }}>
                <Link
                    to="/dictionary"
                    className="button1 flex justify-center text-white text-4xl font-bold py-4 px-6 rounded-lg bg-purple-500 hover:bg-purple-800 transition duration-300 ease-in-out mb-4 w-full top-30%"
                >
                    Use Dictionary
                </Link>
                <Link
                    to="/vocabulary-activity"
                    className="button1 flex justify-center text-white text-4xl font-bold py-4 px-6 rounded-lg bg-purple-500 hover:bg-purple-800 transition duration-300 ease-in-out mb-4 w-full"
                >
                    Vocabulary Activity
                </Link>
            </div>
