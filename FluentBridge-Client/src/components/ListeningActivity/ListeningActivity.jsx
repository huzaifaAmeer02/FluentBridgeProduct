...
const ListeningActivity = () => {
    ...
    const jobs = [
        {
            title: "Labour",
            //image:"https://img.freepik.com/free-vector/construction-illustration-with-foreman-giving-instructions-team-builders-dressed-uniform-helmets_1284-29082.jpg?t=st=1710990122~exp=1710993722~hmac=a99f477327206f96abe89a0f6424cca15840d1bbb94719a7215a0a4a2fddc5e1&w=996",
        ...
        <>
            {loading ? (
                ...
                <section className="py-8 relative bg-purple-100">
                    ...
                    {/* Render VideoPage if a job is selected */}
                    {selectedJob && (
