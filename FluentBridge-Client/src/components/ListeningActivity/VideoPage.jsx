    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50">
            <div className="bg-purple-200 p-8 rounded-lg relative">
                ...
                />
                <Link to="/listeningquiz" className="block text-center mt-4 bg-purple-700 text-white px-4 py-2 rounded-md hover:bg-purple-950 transition duration-300">Take Quiz</Link>
            </div>
        </div>
    );
};
