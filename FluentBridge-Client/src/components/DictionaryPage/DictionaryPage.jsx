...
const DictionaryPage = () => {
    ...
    return (
        <>
            ...
            <animated.section style={{ ...fadeIn, minHeight: '100vh', paddingTop: '2rem', paddingBottom: '2rem',background: 'radial-gradient(circle, #220233, #000000)' }} className="text-gray-600 body-font flex flex-col lg:flex-row justify-center items-center lg:items-stretch">
                <Lottie animationData={dictionarypage} 
                        className="lg:w-1/2 object-cover rounded-lg lg:mr-6 mt-8 lg:mt-0" 
                        style={{
                            filter: 'drop-shadow(0px 0px 20px rgba(255, 255, 255, 0.5))',
                            borderRadius: '15px', // You can adjust this to match the rounded corners
                        }}/>
                
                <animated.div style={{ ...slideIn, delay: 200 }}  className="lg:w-1/2  text-white pt-20 p-8 h-auto rounded-lg lg:mx-9 mt-20 mb-20">
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start w-full">
                        <Link to="/dictionaryapi"> {/* Update the route to the correct destination */}
